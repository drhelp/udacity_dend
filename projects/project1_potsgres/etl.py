...
def process_song_file(cur, filepath):
    '''
    Processes single song file and insert rows into songs and artists
    database tables.
...
def process_log_file(cur, filepath):
    '''
    Processes single log file and insert rows into timem users
    and songplay database tables.
    ...
    time_data = (t.dt.to_pydatetime(), t.dt.hour, t.dt.day, t.dt.weekofyear,
...
def process_data(cur, conn, filepath, func):
    '''
    Wrapper function for data processing. Iterate through *.json
    files in filepath
    and call load specified load function for each file
